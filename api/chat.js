...
[
  ...
  },
  {
    ...
    "reagents": "",
    "conditions": "",
    "answer": "a. \\\\ce{ClO^-} + \\\\ce{Cl^-} + 2\\\\ce{H^+} \\\\rightarrow \\\\ce{Cl2} + \\\\ce{H2O}\\nb. 2\\\\ce{Al} + 2\\\\ce{OH^-} + 6\\\\ce{H2O} \\\\rightarrow 2\\\\ce{[Al(OH)4]^-} + 3\\\\ce{H2}\\nc. 2\\\\ce{Na} + 2\\\\ce{NH3} \\\\rightarrow 2\\\\ce{Na^+} + 2\\\\ce{NH2^-} + \\\\ce{H2}\\nd. \\\\ce{[PtCl4]^{2-}} + 2\\\\ce{NH3} \\\\rightarrow \\\\text{cis-}\\\\ce{Pt(NH3)2Cl2} + 2\\\\ce{Cl^-}\\ne. \\\\ce{Et3C-Br} + t\\\\text{-BuO}^- \\\\rightarrow \\\\ce{Et2C=CHCH3} + t\\\\text{-BuOH} + \\\\ce{Br^-}\\nf. ^{57}_{27}\\\\ce{Co} + e^- \\\\rightarrow ^{57}_{26}\\\\ce{Fe} + \\\\nu_e",
    "instructions": "5. [12%] Write net equations for each of the reactions below. Use appropriate ionic and molecular formulas and omit formulas for all spectator ions or molecules that do not take part in a reaction. Write structural formulas for all organic substances, and clearly show stereochemistry where relevant. You need not balance the equations or show the phase of the species.\\n\\na. Aqueous hydrochloric acid is added to a solution of sodium hypochlorite.\\nb. Aluminum foil is added to concentrated aqueous potassium hydroxide solution.\\nc. Metallic sodium is added to liquid ammonia in the presence of a trace amount of iron(III) nitrate.\\nd. Potassium tetrachloroplatinate is heated with two equivalents of aqueous ammonia.\\ne. Sodium tert-butoxide is added to 3-bromo-3-ethylpentane in N,N-dimethylformamide (DMF) solution.\\nf. Cobalt-57 undergoes radioactive decay by electron capture.",
    "hint": "Remember that hydrochloric acid provides both H+ and Cl- to react with hypochlorite, and tert-butoxide is a sterically hindered strong base promoting E2 elimination.",
    "explanation": "a. Adding strong hydrochloric acid to hypochlorite forms chlorine gas:\\n$$\\\\ce{ClO^-} + \\\\ce{Cl^-} + 2\\\\ce{H^+} \\\\rightarrow \\\\ce{Cl2} + \\\\ce{H2O}$$\\n\\nb. Aluminum reacts with hydroxide to form tetrahydroxoaluminate and hydrogen gas:\\n$$2\\\\ce{Al} + 2\\\\ce{OH^-} + 6\\\\ce{H2O} \\\\rightarrow 2\\\\ce{[Al(OH)4]^-} + 3\\\\ce{H2}$$\\n\\nc. In liquid ammonia with Fe(III) catalyst, sodium is oxidized to sodium amide:\\n$$2\\\\ce{Na} + 2\\\\ce{NH3} \\\\rightarrow 2\\\\ce{Na^+} + 2\\\\ce{NH2^-} + \\\\ce{H2}$$\\n\\nd. Direct substitution of platinum(II) coordinates with two equivalents of ammonia selectively yields cisplatin:\\n$$\\\\ce{[PtCl4]^{2-}} + 2\\\\ce{NH3} \\\\rightarrow \\\\text{cis-}\\\\ce{Pt(NH3)2Cl2} + 2\\\\ce{Cl^-}$$\\n\\ne. The E2 elimination of a tertiary alkyl halide 3-bromo-3-ethylpentane using a bulky base (tert-butoxide) yields 3-ethyl-2-pentene:\\n$$\\\\ce{Et3C-Br} + t\\\\text{-BuO}^- \\\\rightarrow \\\\ce{Et2C=CHCH3} + t\\\\text{-BuOH} + \\\\ce{Br^-}$$\\nIn SMILES:\\n\\\`[[SMILES: CCC(CC)(CC)Br]]\\\` + \\\`[[SMILES: CC(C)(C)[O-]]]\\\` $\\\\rightarrow$ \\\`[[SMILES: CCC(=CC)CC]]\\\` + \\\`[[SMILES: CC(C)(C)O]]\\\` + $\\\\ce{Br^-}$\\n\\nf. Cobalt-57 electron capture converts a proton in the nucleus to a neutron, emitting a neutrino:\\n$$^{57}_{27}\\\\ce{Co} + e^- \\\\rightarrow ^{57}_{26}\\\\ce{Fe} + \\\\nu_e$$"
  }
]
